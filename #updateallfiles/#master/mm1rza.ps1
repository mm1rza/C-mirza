...
switch ($choice) {
    ...
    "3" {
		...
		Start-Process powershell -ArgumentList "-NoProfile -ExecutionPolicy Bypass -Command `"iex (iwr 'https://raw.githubusercontent.com/mm1rza/aio-mirza/main/%23updateallfiles/update.ps1' -UseBasicParsing)`"" -Verb RunAs
    }
    default {
